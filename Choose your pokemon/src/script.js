...
function nextpokemonShufflePic(data) {
    var mainContainer = document.getElementById("pic_main");
    var picpokemon = data.sprites;
    var shuffleArray = [];
    var count = 0;
...
function clickNext() {
    let next_poke = document.getElementById("next_pokemon");
    next_poke.addEventListener('click', nextPokemon());
}
